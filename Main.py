...
plt.title('Потери на обучающем и проверочном наборе')
plt.legend()
plt.show()
...
plt.plot(time, y_test, label='Курс акций')
plt.plot(time, y_hat, label='Предсказанный курс акций')
plt.title('Предсказание гибридной модели')
plt.xlabel('Дата', fontsize=12, verticalalignment='top')
plt.ylabel('Цена', fontsize=14, horizontalalignment='center')
plt.legend()
plt.show()